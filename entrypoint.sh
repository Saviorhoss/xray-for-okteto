...
UUID='0bc23239-1f3d-49d0-af4b-4ea185ff4395'
VMESS_WSPATH='/vmess'
VLESS_WSPATH='/vless'
...
wget https://github.com/Loyalsoldier/v2ray-rules-dat/releases/download/202312042209/geoip.dat
wget https://github.com/Loyalsoldier/v2ray-rules-dat/releases/download/202312042209/geosite.dat
